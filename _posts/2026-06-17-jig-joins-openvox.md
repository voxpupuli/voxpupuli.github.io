...
Jig has always been open source, and its move into OpenVox ensures that it is no
longer dependent on a single individual's account or availability. Issues,
