---
layout: post
title: New openvox-agent 8.25.0 releases
date: 2026-02-17
github_username: bastelfreak
---

[As promised last week](https://voxpupuli.org/blog/2026/02/10/new-openvox-agent-8.25.0-RC-releases/), we have a new set of openvox-agent packages. 8.25.0 brings support for many new platforms!
...
**Please download them and provide feedback [in the openvox Slack/IRC channel](https://voxpupuli.org/connect/). We will provide new OpenBolt packages in the next couple of days as well**

**Gem Changes:**

changes compared to our RC:

* rubygem-aws-sdk-ec2 was at 1.597.0 and is now at 1.601.0
...
| rubygem-aws-sdk-ec2 | 1.583.0 | 1.601.0 |
